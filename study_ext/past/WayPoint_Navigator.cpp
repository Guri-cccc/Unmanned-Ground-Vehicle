...
class Waypoint_Naigator{
    ...
    ros::Publisher Destination_body_pub;
...
Waypoint_Naigator::Waypoint_Naigator(ros::NodeHandle n){
    ...
    GPS_Out_sub = nh.subscribe("/gps_out", 10, &Waypoint_Naigator::GPS_OutCallback, this);
...
void Waypoint_Naigator::GPS_OutCallback(const hellocm_msgs::GPS_Out& msg){

    geometry_msgs::PoseStamped PoseStamped_buf[1];
